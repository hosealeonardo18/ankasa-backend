...
const insertReviews = (data) => {
    ...
    return Pool.query(`INSERT INTO reviews VALUES('${id}', '${id_user}', 
        '${id_flight}', '${rating}', '${title}' , '${description}')`);
};

const updateReviews = (data) => {
    const { id, rating, title, description } = data;
    return Pool.query(`UPDATE reviews SET rating='${rating}', title='${title}', 
...
const findId = (id) => {
    return new Promise((resolve, reject) =>
        Pool.query(`SELECT id FROM reviews WHERE id='${id}'`,
